...
public class SpaceInvadersActivitytwo extends Activity {

    // spaceInvadersView will be the view of the game
    // It will also hold the logic of the game
    // and respond to screen touches as well
    SpaceInvadersViewer spaceInvadersViewer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spaceInvadersViewer = new SpaceInvadersViewer(this, size.x, size.y);
        setContentView(spaceInvadersViewer);
